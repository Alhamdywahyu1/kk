...
class Knapsack_PSO():
    ...
    def initial(self):
        for i in range(self.pop_size):
            ...
            self.fitnesspBest.append([0, mutasi,temp2])
    ...
    def updateVelocity(self, indPartikel, ind):
        ...
        posisi = self.dataConvert[indPartikel][ind][0]
        v = self.dataConvert[indPartikel][ind][2]
        pBest = self.fitnesspBest[indPartikel][2][ind]
        gBest = self.gBest[2][ind]
    ...
    def run(self):
        ...
        # update biner sebelum tampil hasil akhir
        # newBiner = ''
        # for i in self.gBest[2]:
        #     if i < self.treshold:
        #         newBiner += '0'
        #     else:
        #         newBiner += '1'
        # self.gBest[1] = newBiner
